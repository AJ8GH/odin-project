...
describe '#bubble_sort' do
  let(:long_array) do
    [2, 7, 9, 3, 4, 8, 43, 2, 234, 7, 456, 547, 4567, 4567, 232, 3, 3, 5, 1, 5, 8, 8, 9, 0]
  end

  let(:string_array) { %w[w g s e g x f r d] }

  let(:long_string_array) do
    %w[se yu fg d s s c iuy mn qwe zxc sdf yui gnb gfg gbfgb sdfwefweasd
